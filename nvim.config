...
" Map <leader>q to write all buffers and exit Vim. Prompts if a buffer cannot
" be written to disk.
nnoremap <silent> <leader>q :confirm xall<CR>
...
" Map <leader>c to close windows and splits
